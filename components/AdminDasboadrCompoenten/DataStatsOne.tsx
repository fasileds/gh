...
const DataStatsOne: React.FC<dataStats> = () => {
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5 px-6">
        {dataStatsList.map((item, index) => (
          <div
            key={index}
            className="rounded-xl bg-white p-6 shadow-lg hover:shadow-2xl transform transition-all duration-300 ease-in-out hover:scale-105 dark:bg-gray-dark dark:shadow-lg dark:hover:shadow-xl"
          >
            <div
